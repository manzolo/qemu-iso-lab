...
`freebsd` installs the public FreeBSD 14.3 disc1 on BIOS/pc with a virtio
...
[recorded live results](../../PROFILE_TODO.md). The manual `freebsd-installer` profile remains available.
