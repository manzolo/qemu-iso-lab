...
`freebsd-unattended` installa la disc1 pubblica di FreeBSD 14.3 su BIOS/pc con disco
...
e gli [esiti dal vivo](../../PROFILE_TODO.md). Resta disponibile il profilo manuale `freebsd`.
