...
class _VmctlFacade:
    ...
    _SEARCH_ORDER = (
        vmctl.lifecycle, vmctl.libvirt, vmctl.pfsense, vmctl.reactos, vmctl.scheduler, vmctl.netlab, vmctl.report, vmctl.profiledoc, vmctl.ssh, vmctl.host_setup, vmctl.flash, vmctl.flash_allocated, vmctl.import_dev, vmctl.disk_inspect,
        vmctl.iso, vmctl.alpine, vmctl.autoyast, vmctl.windows, vmctl.archinstall, vmctl.omarchy, vmctl.preseed, vmctl.kickstart, vmctl.cloud_init, vmctl.qemu, vmctl.config,
