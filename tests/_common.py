...
class _VmctlFacade:
    ...
    _SEARCH_ORDER = (
        vmctl.lifecycle, vmctl.libvirt, vmctl.pfsense, vmctl.reactos, vmctl.netlab, vmctl.report, vmctl.ssh, vmctl.host_setup, vmctl.flash, vmctl.flash_allocated, vmctl.import_dev, vmctl.disk_inspect,
